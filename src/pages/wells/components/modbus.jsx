                ...
                <Grid container sx={{ mt: -1.4 }}>
                    <Grid item lg={5} md={12} sm={12} xs={12}>
                        <Typography variant="h6" color="textSecondary" sx={{ mt: 1.4 }}>
                             {firstLoad ? <>Статус ModBus&nbsp;&nbsp; <CheckOnline isOnline={wellData?.data?.status} /></> : <Skeleton variant="text" sx={{ fontSize: '1.7rem', width: 170,mb: -1.1, mt: -1.2 }} />}
                        </Typography>
                        <Divider sx={{ mt: 1.8 }} />
                        <Typography variant="h6" color="textSecondary" sx={{ mt: 1.4 }}>
                            Device IP: &nbsp;&nbsp;
                    ...
                    <Grid item lg={7} md={12} sm={12} xs={12}>
                        ...
                        <Typography variant="h6" color="textSecondary" sx={{ mt: 1.4 }}>
                            ...
                            />&nbsp;&nbsp;
                            <Chip
                                label={data?.modbus?.commands?.turnOn?.value ?? 'NaN'}
                                color="secondary"
                                variant="combined"
                                size="small"
                            />
                            &nbsp;&nbsp;<Chip label={data?.modbus?.commands?.turnOn?.function ? processString(data?.modbus?.commands?.turnOn?.function): 'NaN Func'} color="primary" size="small" variant="combined" />
                        </Typography>
                        <Typography variant="h6" color="textSecondary" sx={{ mt: 1.4 }}>
                            Вимкнення: &nbsp;&nbsp;
                            <Chip
                                ...
                                />&nbsp;&nbsp;
                                <Chip
                                    label={data?.modbus?.commands?.turnOff?.value ?? 'NaN'}
                                    color="secondary"
                                    variant="combined"
                                    size="small"
                                />
                                &nbsp;&nbsp;<Chip label={data?.modbus?.commands?.turnOff?.function ? processString(data?.modbus?.commands?.turnOff?.function ): 'NaN Func'} color="primary" size="small" variant="combined" />
                        </Typography>
                        <Typography variant="h6" color="textSecondary" sx={{ mt: 1.4 }}>
                            Скидання аварій: &nbsp;&nbsp;
                            <Chip
                                ...
                                />&nbsp;&nbsp;
                                <Chip
                                    label={data?.modbus?.commands?.reset?.value ?? 'NaN'}
                                    color="secondary"
                                    variant="combined"
                                    size="small"
                                />
                                &nbsp;&nbsp;<Chip label={data?.modbus?.commands?.reset?.function ? processString(data?.modbus?.commands?.reset?.function): 'NaN Func'} color="primary" size="small" variant="combined" />
                        </Typography>
                    </Grid>
                </Grid>
