...
const WellDisAlrtsModal = ({ wellID, data }) => {
    ...
    return (
        <>
                    ...
                    <Grid xs={9}>
                        {data?.events?.resetAlerts?.date ? <>Остання дія <TimeAgo targetTime={new Date(data?.events?.resetAlerts?.date)} /></>: "Дії відсутні"}
                    </Grid>
...
Після перевірки і підтвердження аварійної ситуації, ви можете натиснути кнопку <b>Скинути аварії</b>, щоб відновити нормальний режим роботи. Проте, якщо у вас є сумніви або питання стосовно цієї аварійної ситуації, будь ласка, негайно зверніться до адміністратора або інженера для отримання додаткової інформації та необхідної підтримки. Ваша безпека та правильна реакція на аварійні ситуації - наш пріоритет.
                        </Typography>
