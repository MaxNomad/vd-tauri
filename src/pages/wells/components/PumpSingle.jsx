                                        ...
                                        <>
                                            ...
                                            <Grid item xs={12} sm={5.5} md={5.5} lg={5.5} sx={{ mt: -2.75 }}>
                                                ...
                                                <Typography variant="h6" color="textSecondary" sx={{ mt: 1.4 }}>
                                                    ...
                                                    Напрацьовано:&nbsp;&nbsp;<NumberWithAnimation number={(data?.pump?.engineHours ?? 0).toFixed(2)} one />&nbsp;<b>Год</b>
                                                </Typography>
                                                <Typography variant="h6" color="textSecondary" sx={{ mt: 1.4 }}>
                                                    Кількість запусків:&nbsp;&nbsp;<b><NumberWithAnimation number={(data?.pump?.runTimes ?? 0).toFixed(2)} one /></b>
                                                </Typography>
                                                <Typography variant="h6" color="textSecondary" sx={{ mt: 1.4 }}>
                                                    Тиск:&nbsp;&nbsp;
                                                ...
                                                <Typography variant="h6" color="textSecondary" sx={{ mt: 1.4 }}>
                                                    Лічильник води:&nbsp;&nbsp;<NumberWithAnimation number={(data?.waterMeter ?? 0).toFixed(2)} one/>&nbsp;<b>м³</b>
                                                </Typography>
                                                <Typography variant="h6" color="textSecondary" sx={{ mt: 1.4 }}>
                                                    Миттєва втрата:&nbsp;&nbsp;<NumberWithAnimation number={(data?.InstWconsumption ?? 0).toFixed(2)} />&nbsp;<b>м³/год</b>
                                                </Typography>
                                            </Grid>
                                            ...
                                            <Grid item xs={12} sm={6.5} md={6.5} lg={6.5} sx={{ mt: -2.75 }}>
                                                ...
                                                <Typography variant="h6" color="textSecondary" sx={{ mt: 1 }}>
                                                    ...
                                                    <b>
                                                        ...
                                                        <NumberWithAnimation number={(
                                                            ((data?.voltage_L1 * data?.pump?.currentAmpsL1 + data?.voltage_L2 * data?.pump?.currentAmpsL2+ data?.voltage_L3 * data?.pump?.currentAmpsL3)/1000)
                                                        ).toFixed(2)} />{' '}
                                                        Кв/год.
                                                    </b>{' '}
                                                ...
                                                <Typography variant="h6" color="textSecondary" sx={{ mt: 0.9 }}>
                                                    <b>L1:</b> <NumberWithAnimation number={(data?.voltage_L1 ?? 0).toFixed(0)} />V | <b>L2:</b> <NumberWithAnimation number={(data?.voltage_L2 ?? 0).toFixed(0)} />V |{' '}
                                                    <b>L3:</b> <NumberWithAnimation number={(data?.voltage_L3 ?? 0).toFixed(0)} />V
                                                </Typography>
                                                <p />
                                                <Typography variant="h6" color="textSecondary" sx={{ mt: 0.9 }}>
                                                    <b>L1:</b>  <NumberWithAnimation number={(data?.pump?.currentAmpsL1 ?? 0).toFixed(2)} rev/>A | <b>L2:</b>  <NumberWithAnimation number={(data?.pump?.currentAmpsL2 ?? 0).toFixed(2)} rev/>A |{' '}
                                                    <b>L3:</b> <NumberWithAnimation number={(data?.pump?.currentAmpsL3 ?? 0).toFixed(2)} rev/>A
                                                </Typography>
                                            </Grid>
                                            <Grid item xs={12} sm={12} md={12} lg={12} sx={{ mt: -3.25 }}>
                                            <Typography variant="h6" color="textSecondary" >
                                                    Лічильник електроенергії:&nbsp;&nbsp;<NumberWithAnimation number={(data?.energyMeter ?? 0).toFixed(2)} one/>&nbsp;<b>Кв.год.</b>
                                                </Typography>
                                            </Grid>
                                        </>
                                    ) : (
