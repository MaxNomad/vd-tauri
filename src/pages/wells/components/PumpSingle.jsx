...
import SmallWellController from './modals/smallControll';
                                ...
                                <>
                                    <Grid item xs={12} sm={12} md={12} lg={12} sx={{ mt: -2.25, mb: -2 }}>
                                        <Box direction="column" align="center">
                                            <Typography variant="h5" color="textSecondary" sx={{ mt: { md: 19, xs: 5 } }}>
                                                Технічне обслуговування свердловини №{data?.pumpID}
                                            </Typography>
                                            <Typography variant="h6" color="textSecondary" sx={{ mb: { md: 18.5, xs: 5 } }}>
                                ...
                                <>
                                    ...
                                    <Grid item xs={12} sm={6.5} md={6.5} lg={6.5} sx={{ mt: -2.75 }}>
                                        ...
                                        <Typography variant="h6" color="textSecondary" sx={{ mt: 0.9 }}>
                                            ...
                                            <b>L2:</b> <NumberWithAnimation number={(data?.pump?.currentAmpsL2 ?? 0).toFixed(2)} rev />A |{' '}
                                    ...
                                    <Link to="#" onClick={(e) => e.preventDefault()}>
                                        <SmallWellController wellID={data?.pumpID} data={data}/>
                                        </Link>
                                    </Grid>
