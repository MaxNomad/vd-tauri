...
// project import
import { getPumpAlertsAll } from '../redux/pumpAlertsAllSlice';
...
const AlertsTableAll = ({ pumpID }) => {
    ...
    const { data, loading } = useSelector((state) => state.pumpAlertsAll);
    const { reqData } = useSelector((state) => state.knsAlertDisable);
    const { reqListData } = useSelector((state) => state.knsFoundAlertList);
