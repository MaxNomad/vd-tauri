...
const PumpSinglePage = () => {
    ...
    return (
        <>{pageAccess? <>
            ...
            {(data?.exist ?? firstLoad)? <><PumpHeader
                            ...
                            {data?.alarms?.smoothStartAlarm != null ? (
                                <Grid item xs={12} md={6} lg={6}>
                                    <Status
                                        ...
                                        extraText={!data?.alarms?.smoothStartAlarm ? 'Тиск системи в нормі' : 'Нізький тиск в системі'}
                                    />
                                </Grid>
                            ) : null}
                            {data?.alarms?.lowPresAlarm != null ? (
                                <Grid item xs={12} md={6} lg={6}>
                                    <Status
                                        ...
                                        extraText={!data?.alarms?.lowPresAlarm ? 'Тиск системи в нормі' : 'Нізький тиск в системі'}
                                    />
                                </Grid>
                            ) : null}
                            {data?.warnings?.conectError != null ? (
                                <Grid item xs={12} md={6} lg={6}>
                                    <Status
                                        ...
                                        extraText={!data?.warnings?.conectError ? 'Проблем не виявлено' : 'Виявлено проблему підлючення'}
                                    />
                                </Grid>
                            ) : null}
                            ...
                            {data?.alarms?.sensorPressureAlarm != null ? (
                                <Grid item xs={12} md={6} lg={6}>
                                    <Status
                                        ...
                                        extraText={!data?.alarms?.sensorPressureAlarm ? 'Показник в нормі' : 'Не дійсні дані датчика'}
                                    />
                                </Grid>
                            ) : null}
