                                ...
                                <Grid container rowSpacing={4.5} columnSpacing={2.75} sx={{ mt: 0.2 }}>
                                    ...
                                    <Grid item xs={12} md={4} lg={4}>
                                        <Status
                                            ...
                                            extraText={
                                                !data?.alarms?.globalAlarm ? 'Всі системи працюють в штатному режимі' : 'Збій систем КНС'
                                            }
                                        />
                                    </Grid>
                                    <Grid item xs={12} md={4} lg={4}>
                                    ...
                                    <Grid item xs={12} md={4} lg={4}>
                                        <Status
                                            ...
                                            extraText={
                                                !data?.alarms?.overflowAlarm
                                                    ? `На ${Math.abs(
                                                          (data?.levels?.max - data?.levels?.current).toFixed(2)
                                                      )} см. нижче встановленого значення`
                                                    : `На ${Math.abs(
                                                          (data?.levels?.current - data?.levels?.max).toFixed(2)
                                                      )} см. вище встановленого значення`
                                            }
                                        />
                                    </Grid>
                                    <Grid item xs={12} md={4} lg={4}>
                                        <Status
                                            ...
                                            extraText={
                                                !data?.warnings?.dryRun
                                                    ? `На ${Math.abs(data?.levels?.current - data?.levels?.min).toFixed(
                                                          2
                                                      )} см. вище встановленого значення`
                                                    : `На ${Math.abs(data?.levels?.min - data?.levels?.current).toFixed(
                                                          2
                                                      )} см. нижче встановленого значення`
                                            }
                                        />
                                    ...
                                    <Grid item xs={12} md={4} lg={4}>
                                        <Status
                                            ...
                                            extraText={
                                                !data?.alarms?.floatAlarm ? 'Проблем не виявлено' : 'Виявлено збої в роботі поплавків'
                                            }
                                        />
                                    </Grid>
                                    <Grid item xs={12} md={4} lg={4}>
                                    ...
                                    <Grid container>
                                        <MainCard sx={{ mt: 2 }}>
                                            <Typography variant="h6" color="secondary">
                                                Деактивація усіх аварій ({knsActive?.data?.activeAlarmsListTotal ?? 0})&nbsp;&nbsp;&nbsp;
                                                <Button
                                                    variant="contained"
                                                    color="error"
                                                    size="small"
                                                    disabled={knsActive?.data?.activeAlarmsListTotal === 0 || null}
                                                >
                                                    Деактивація
                                                </Button>
                                                <Tooltip
