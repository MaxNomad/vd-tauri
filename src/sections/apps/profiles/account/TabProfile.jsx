              ...
              <Grid container spacing={3}>
                <Grid item xs={12}>
                  <Stack direction="row" justifyContent="flex-end">
                    <Chip label={userData?.wp_user_level === 10 ? "Admin" : "Member"} size="small" color={userData?.wp_user_level === 10 ? "warning" : "primary"} />
                  </Stack>
                  <Stack spacing={2.5} alignItems="center">
                    <Avatar alt={userData?.user_login} sx={{ width: 128, height: 128 }} src={userData?.wp_user_avatars} />
                ...
                <Grid item xs={12}>
                  <Stack direction="row" justifyContent="space-around" alignItems="center">
                    <Stack spacing={0.5} alignItems="center">
                      <Typography variant="h5">{userData?.wp_user_level ?? 0} <span style={{color: theme.palette.warning.main, fontSize: 10}}>LvL</span></Typography>
                      <Typography color="secondary">Рівень доступу</Typography>
                    </Stack>
                    <Divider orientation="vertical" flexItem />
                    <Stack spacing={0.5} alignItems="center">
                      <Typography variant="h5">{new Date(userData?.user_registered).toLocaleDateString() ?? "Невідомо"}</Typography>
