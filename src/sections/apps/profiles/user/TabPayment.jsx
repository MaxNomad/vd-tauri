                    ...
                    <Stack spacing={1.25} direction="row" justifyContent="space-between" alignItems="center">
                        <Stack direction="row" spacing={1}>
                            <Button
                                ...
                                startIcon={<img src={masterCard} alt="master card" width="12px" height="12px" layout="intrinsic" />}
                            >
                                Card
                            </Button>
                            <Button
                                ...
                                startIcon={<img src={paypal} alt="paypal" width="12px" height="12px" layout="intrinsic" />}
                            >
                                Paypal
                            </Button>
                        </Stack>
                                            ...
                                            <Stack spacing={1.25}>
                                                ...
                                                <LocalizationProvider dateAdapter={AdapterDateFns}>
                                                    <DatePicker
                                                        ...
                                                        renderInput={(params) => (
                                                            <TextField id="payment-card-expiry" fullWidth {...params} helperText={null} />
                                                        )}
                                                        inputFormat="MM/yyyy"
                                                        mask="__/____"
                                                    />
